import{S as e,a4 as r,q as n}from"./index-CRYMJHcY.js";import"./index-BWAoU6UZ.js";const t="volumetricLightingRenderVolumePixelShader",o=`#include<__decl__sceneFragment>
...
`;e.ShadersStore[t]||(e.ShadersStore[t]=o);const a=[r,n];for(const i of a)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const s={name:t,shader:o};export{s as volumetricLightingRenderVolumePixelShader};
