import{S as e,s as r,Q as o}from"./index-DdefR9_n.js";import"./index-EHKLYN7P.js";const i="volumetricLightingRenderVolumePixelShader",n=`#include<sceneUboDeclaration>
...
`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=n);const s=[r,o];for(const t of s)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);const c={name:i,shader:n};export{c as volumetricLightingRenderVolumePixelShaderWGSL};
