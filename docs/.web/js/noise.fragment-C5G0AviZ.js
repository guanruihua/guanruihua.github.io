import{S as o}from"./index-DdefR9_n.js";import"./index-EHKLYN7P.js";const e="noisePixelShader",i=`uniform float brightness;uniform float persistence;uniform float timeScale;varying vec2 vUV;vec2 hash22(vec2 p)
...
`;o.ShadersStore[e]||(o.ShadersStore[e]=i);const a={name:e,shader:i};export{a as noisePixelShader};
