import{S as e,c as i,f as n,l as s,d as a,b as f,e as l}from"./index-Cse8vAY0.js";import"./index-IWEVqSGH.js";const r="gpuRenderParticlesVertexShader",o=`uniform view: mat4x4f;uniform projection: mat4x4f;uniform translationPivot: vec2f;uniform worldOffset: vec3f;
#ifdef LOCAL
...
`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=o);const v=[i,n,s,a,f,l];for(const t of v)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);const d={name:r,shader:o};export{d as gpuRenderParticlesVertexShaderWGSL};
