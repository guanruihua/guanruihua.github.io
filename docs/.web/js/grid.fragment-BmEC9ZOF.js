import{S as i,z as t,r,A as a,B as f,C as d,D as l,E as s}from"./index-Y1WqlHGW.js";import"./index-BjVq-VvI.js";const o="gridPixelShader",n=`#extension GL_OES_standard_derivatives : enable
...
`;i.ShadersStore[o]||(i.ShadersStore[o]=n);const c=[t,r,a,f,d,l,s];for(const e of c)i.IncludesShadersStore[e.name]||(i.IncludesShadersStore[e.name]=e.shader);const O={name:o,shader:n};export{O as gridPixelShader};
