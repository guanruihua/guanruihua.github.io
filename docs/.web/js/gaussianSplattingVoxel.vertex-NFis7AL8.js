import{S as a,Z as o,q as r,_ as n,$ as l,a1 as s}from"./index-Y1WqlHGW.js";import"./index-BjVq-VvI.js";const e="gaussianSplattingVoxelVertexShader",i=`#include<__decl__gaussianSplattingVertex>
...
#endif
vPatchPosition=position.xy;}`;a.ShadersStore[e]||(a.ShadersStore[e]=i);const p=[o,r,n,l,s];for(const t of p)a.IncludesShadersStore[t.name]||(a.IncludesShadersStore[t.name]=t.shader);const m={name:e,shader:i};export{m as gaussianSplattingVoxelVertexShader};
