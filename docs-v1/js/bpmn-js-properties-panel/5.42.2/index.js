...
class BpmnPropertiesPanelRenderer {
  ...
  _updateGroups() {
    if (!this._selectedElement || isImplicitRoot(this._selectedElement) || minDash.isArray(this._selectedElement)) {
      this._groups = [];
      return;
    }
    const providers = this._getProviders(this._selectedElement);
    this._groups = minDash.reduce(providers, (groups, provider) => {
