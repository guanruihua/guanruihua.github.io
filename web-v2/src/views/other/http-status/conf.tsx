export const HttpStatusList = [
  ...
  TRACE: 消息正文包含服务器收到的请求消息。`,
      ...
      [
        ...
        `服务器已成功处理了请求，但返回的实体头部元信息不是在原始服务器上有效的确定集合，而是来自本地或者第三方的拷贝。当前的信息可能是原始版本的子集或者超集。例如，包含资源的元数据可能导致原始服务,器知道元信息的超集。使用此状态码不是必须的，而且只有在响应不使用此状态码便会返回200 OK的情况下才是合适的。`,
        '非权威信息',
      ],
  ...
  },
  {
    ...
    children: [
      ...
      [
        '305',
        `Use Proxy`,
        `已弃用 在 HTTP 规范中定义，以指示请求的响应必须被代理访问。由于对代理的带内配置的安全考虑，它已被弃用。`,
        '使用代理',
      ],
      [
        '306',
  ...
  },
  {
    ...
    children: [
      ...
      ['423', `Locked (WebDAV)`, `正在访问的资源已锁定。`, '已锁定'],
      [
        '424',
