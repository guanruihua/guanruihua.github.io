...
export default function () {
  usePageState()
  return (
    <div className="animation__toast-catcher-game">
      <div className="frame">
        <svg
          id="game"
        ...
        >
          ...
          />
          <g fill="#FEDAA1" fontFamily="inherit">
            <text id="score" x="25" y="46">
              00000000
            </text>
            <text id="lives" x="345" y="46" fontFamily="inherit"></text>
          </g>
